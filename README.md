...
**Project**: blue-sky-todo-list 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: create a todo app with a blue background 
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/blue-sky-todo-list.git
cd blue-sky-todo-list
npm i
